...
video_path = r"C:\Users\Pai\Desktop\9periodo\marcha\P_0001_1.MOV"  # Substitua pelo caminho do seu vídeo
...
out = cv2.VideoWriter('output.avi', fourcc, fps, (width, height)) # Salvar como 'output.avi'
